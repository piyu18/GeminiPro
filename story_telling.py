...
submit=st.button("Get Story")

input_prompt = """
               You are an expert in story telling
               You will receive input images & you have to write a short story
               based on the image.
               """
...
if submit:
    ...
    #st.image("3D_Image.jpg", caption="3D Illustrated Image", use_column_width=True)
